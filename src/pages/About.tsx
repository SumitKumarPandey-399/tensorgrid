    ...
    <Section title={aboutContent.title} subtitle={aboutContent.introduction}>
      <div className="grid gap-6 md:grid-cols-2">
        <article className="glass-panel rounded-2xl p-6">
          <h3 className="text-xl font-semibold text-slate-900">{aboutContent.visionTitle}</h3>
          <p className="mt-3 text-slate-600">{aboutContent.vision}</p>
        </article>
        <article className="glass-panel rounded-2xl p-6">
          <h3 className="text-xl font-semibold text-slate-900">{aboutContent.missionTitle}</h3>
